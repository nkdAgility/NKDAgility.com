...
```json
{
  ...
  "reasoning_summary": "<A Generative Experience Optimisation summary of the reasoning that is conversational, professional, and explains why the content fits (or doesn’t fit) the category, without copying the original reasoning. No more than 500 characters.>"
}
