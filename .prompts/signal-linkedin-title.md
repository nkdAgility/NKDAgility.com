You are an expert in **Generative Experience Optimisation (GEO)**. Your task is to generate a **GEO-optimised title** of no more than **60 characters**, based on the provided content.
