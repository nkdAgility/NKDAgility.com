...
Instructions: |-
  **Use this tag only for content focused on accountability as a structural concept.**  
  Accountability describes who owns the outcome in a system of work. It is distinct from task ownership or decision authority. This tag applies to posts that explore how clearly defined accountabilities improve transparency, alignment, and outcome responsibility in Agile, Scrum, and DevOps systems.

  **Key Topics:**
  - Defined accountabilities in Scrum (Scrum Team, Scrum Master, Product Owner)
  - The difference between accountability, responsibility, and authority
  - System-level outcomes and who owns them
  - Organisational design patterns that clarify or obscure accountability
  - Impact of misaligned or absent accountabilities
  - Evidence-Based Management and outcome ownership

  **Strictly exclude:**
  - Content focused solely on personal motivation or team values
  - General leadership philosophy not rooted in outcome ownership
  - Discussions of practices or methods not tied to structural outcome ownership
headline:
  cards: []
  title: Accountability
  ...
  updated: 2025-04-09T15:20:00Z
sitemap:
  filename: sitemap.xml
  priority: 0.7
BodyContentGenDate: 2025-04-09T12:39:25
