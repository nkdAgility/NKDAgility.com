...
How we measure value up until now in software delivery has been to either rely on the [Product Owner]({{< ref "/tags/product-owner" >}}), or to start introducing traditional measures from formal process… and we already know where that leads. The dark side!
...
There are really three groups of metrics that make sense at the organisational level. There are metrics that monitor the **[current value]({{< ref "/tags/current-value" >}})** being delivered, the **[time to market]({{< ref "/tags/time-to-market" >}})** and your organisations **[ability to innovate]({{< ref "/tags/ability-to-innovate" >}})**. We need to gather these metrics at a point in time as soon as possible to provide a baseline for where the organisation currently is. We can then reassess the organisation at intervals, probably no more than quarterly, which will allow us to look at the trends over time.
...
- **[Revenue per Employee]({{< ref "/tags/revenue-per-employee" >}})** – Gather the revenue generated by the product you are evaluating and employees contributing to its success
...
- **[Customer satisfaction]({{< ref "/tags/customer-satisfaction" >}})** – what percentage of your customers is marketing your products or services on your behalf?
...
- **[Cycle time]({{< ref "/tags/cycle-time" >}})** – How long does it take for us to move new features from idea into customer’s hands?
...
- **Defects** – How much [technical debt]({{< ref "/tags/technical-debt" >}}) are we accumulating?
...
Scrum.org suggests aggregating these into one, easy to track metric – the Agility Index. This number becomes synonymous with the value an organization is getting from its [software development]({{< ref "/tags/software-development" >}}) capabilities.
