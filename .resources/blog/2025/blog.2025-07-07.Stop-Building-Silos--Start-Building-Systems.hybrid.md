...
When every team uses a different deployment tool, stores secrets in a [personal]({{< ref "/tags/personal" >}}) vault, and runs tests on unmonitored boxes, you’ve created a system that _no one_ understands and _no one_ can change safely.
