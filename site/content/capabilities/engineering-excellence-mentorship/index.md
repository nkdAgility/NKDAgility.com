...
sections:
  - type: headline
    headline:
      title: Your engineers aren't the problem.
      content: |
        You've hired talented developers. You've invested in infrastructure. You've set ambitious goals.

        So why does shipping software still feel like fighting through quicksand?
  - type: outcomehero
    cta:
      content: Your engineers aren't the problem. **Your system is.**
      button:
        text: Let's Talk
  ...
  - type: none
    ...
    class: sideBySide
    title: The gap between struggling teams and high-performing teams isn't methodology.
    subtitle: It's engineering practice.
    content: |
      Spotify doesn't ship with confidence because of how they organize teams.

      Netflix doesn't deploy hundreds of times per day because of their process framework.

      Amazon doesn't scale to millions of customers because they follow a particular methodology.

      **They mastered the engineering fundamentals.**

      They built environments where code quality, deployment confidence, architectural clarity, and continuous improvement aligned—every single day.

      **And here's the breakthrough:**

      You don't need to wait years for transformation.

      You don't need to rip out your entire system.

      You don't need a six-month consulting engagement that disrupts everything.

      You need one hour. Every week. With someone who's engineered it.
  - type: none
    class: sideBySide
    title: Meet the engineer who's transformed 250+ software teams from chaos to excellence.
    content: |
      **Martin Hinshelwood** isn't a process consultant. He's an engineer.

      - 17-year Microsoft MVP in DevOps, recognized for real-world impact on software delivery, year after year
      - Professional Scrum Trainer, but more importantly, an expert in engineering practices that transcend any framework
      - 1,00+ engagements across the US, UK, and Europe, from 5-person startups to Fortune 500 engineering organizations
      - Engineering excellence, lived daily, not taught from theory, but forged in production environments under real pressure

      *Martin has debugged the systems you're fighting.*

      He's mentored the overwhelmed tech leads. He's coached the frustrated engineering managers. He's guided the CTOs who know something's broken but can't see what.

      **And he's distilled decades of software engineering wisdom into one accessible format:**

      60 minutes a week. Your team. Real problems. Real solutions.
  - type: cards
    ...
    cards:
      ...
      - content: |
          **Month 1:** Deployments start feeling less scary. Code reviews become learning opportunities instead of bottlenecks. Engineers start seeing the path forward.
      - content: |
          **Month 3:** Technical debt stops compounding. Your architecture decisions create options instead of constraints. Quality improves while velocity increases.
      - content: |
          **Month 6:** Deployment confidence becomes your superpower. Time from code-complete to customer value shrinks dramatically. Engineers stop talking about leaving.
      - content: |
