...
delivery:
  ...
  format: |-
    <!-- wp:heading {"level":3} --><!-- wp:paragraph {"dynamicAttributes":{"toolsetDSVersion":"240000"}} -->  Over the five half-day students are introduced to an existing and complex pre-existing product that they are expected to update and improve over a series of Sprints. Students are expected to apply increasingly sophisticated modern engineering practices using the Scrum Framework to manage the complexity. The core focus is on delivering increments of releasable functionality using those modern engineering practices while fending off common challenges of the workplace in a safe space to experiment and improve.  <!-- /wp:paragraph --><!-- wp:list -->
    - <!-- wp:list-item -->    - Session 1: **The Scrum Refressher**, & **Our Case Study**

    <!-- /wp:list-item --><!-- wp:list-item -->
    - - Session 2: **Product Backlog Refinement**, & **DevOps** & Sprint 1

    <!-- /wp:list-item --><!-- wp:list-item -->
    - - Session 3: **Quality Software**, & Sprint 2

    <!-- /wp:list-item --><!-- wp:list-item -->
    - - Session 4: **Emergant Archtecture**, **Quality Code**, & Sprint 3
