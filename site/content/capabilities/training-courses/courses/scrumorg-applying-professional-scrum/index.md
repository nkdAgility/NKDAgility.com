...
delivery:
  ...
  format: |-
    <!-- wp:paragraph {"dynamicAttributes":{"toolsetDSVersion":"240000"}} -->  Each of the four 210-minute sessions included a 70m Sprint within which the participants can practice in a safe space to experiment and learn:  <!-- /wp:paragraph --><!-- wp:list -->
    - <!-- wp:list-item -->    - Session 1: **Fundamentals of Scrum** & Sprint 1

    <!-- /wp:list-item --><!-- wp:list-item -->
    - - Session 2: **Exploring the Scrum Framework** & Sprint 2

    <!-- /wp:list-item --><!-- wp:list-item -->
    - - Session 3: **Deeper into Scrum** & Sprint 3
