...
syllabus:
- id: 1
  title: Theory and First Principles
  duration: 120
  content: |
    In this module, participants will explore the fundamental concepts and principles that underpin successful Product Backlog management. This includes understanding complexity in product development, empirical process control, and the importance of transparency in decision-making.
  learningResources:
    ...
    - title: A Leader's Framework for Decision Making
      ...
      type: newspaper
      weight: 1 
    - title: The Three Pillars of Empiricism
      link: 
      duration: 2
      type: blog
      weight: 1
    ...
    - title: So What is Agile Really About?
      ...
      weight: 1
- id: 2
  title: Exploring the Scrum Framework & Done
  duration: 120
  content: |
    This module focuses on understanding the Scrum Framework and the concept of "Done" in the context of product development. Participants will learn how these elements contribute to effective Product Backlog management and value delivery.
  learningResources:
...
- id: 3
  ...
  duration: 120
  content: |
    This module examines how Scrum facilitates effective product delivery, with an emphasis on planning, forecasting, and managing workflow. Participants will learn how to leverage these concepts to optimize their Product Backlog management approach.
  learningResources:
    ...
    - title: "Limiting Work in Progress (WIP) in Scrum with Kanban - What / When / Who / How"
      ...
      weight: 1
- id: 4
  title: People, Teams, & The Scrum Master
  duration: 120
  content: |
    This module explores the human aspects of Product Backlog management, including team dynamics, motivation, and the role of the Scrum Master. Participants will learn how to build trust and empathy within their teams to enable more effective collaboration.
  learningResources:
    - title: The Surprising Truth about what motivates us
      ...
      type: video
      weight: 1
    - title: How to Build Trust to Enable Agility
      link: https://www.scrum.org/resources/blog/how-build-trust-enable-agility
      duration: 8
      type: blog
      weight: 1
    - title: Empathy
...
- id: 5
  ...
  duration: 60
  content: |
    This concluding module synthesizes the key learnings from the course, focusing on how participants can apply their new Product Backlog management skills in their specific contexts. It includes reflections on the course journey and guidance for continued growth.
  learningResources: []
events: 
