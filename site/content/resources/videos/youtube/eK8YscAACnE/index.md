...
short_title: Are Story Points and Velocity Hurting Agile Teams?
...
Watermarks:
  ...
  short_title: 2025-06-23T12:38:33Z
...
- **[Cycle Time]({{< ref "/tags/cycle-time" >}})**: This metric measures the time it takes for a task to move from start to finish. It provides a clear picture of how efficiently work is being completed and can help identify bottlenecks in the process.

- **[Throughput]({{< ref "/tags/throughput" >}})**: This refers to the number of tasks completed in a given timeframe. By tracking throughput, teams can gain insights into their capacity and make informed decisions about future work.
