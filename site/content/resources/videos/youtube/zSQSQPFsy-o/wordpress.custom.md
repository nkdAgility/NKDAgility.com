...
tags: 
  - "scrum"
coverImage: "Why-is-Scrum-so-easy-to-understand-but-incredibly-hard-to-master-jpg.webp"
author: "MrHinsh"
type: "nkdresources"
slug: "why-is-scrum-so-easy-to-understand-but-incredibly-hard-to-master"
---

https://youtu.be/zSQSQPFsy-o
...
If you walk into a startup environment, filled with heaps of recent [MIT](https://www.mit.edu/) graduates (Massachusetts Institute of Technology) and a dynamic, agile leader leading the flock, you’re likely to find that **agile** and **scrum** would be quickly understood, adopted, and mastered within that environment.
...
Now, if your team all arrived from Intel, that would be ok because it is common practice to have OKRs ([Objectives and Key Results](https://www.whatmatters.com/faqs/okr-meaning-definition-example#what-is-an-okr%3F-definition-and-examples)) visible at all times. A kind of visual scoreboard for everyone to see what you are working on, how that aligns with strategic objectives, and how you are performing.
